...
/**
  * This is an event sourced entity. It has a state, [[LagomlearnState]], which
  ...
  */
class LagomlearnEntity extends PersistentEntity {

  override type Command = LagomlearnCommand[_]
  override type Event = LagomlearnEvent
  override type State = LagomlearnState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: LagomlearnState = LagomlearnState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case LagomlearnState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        LagomlearnState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class LagomlearnState(message: String, timestamp: String)

object LagomlearnState {
  /**
    ...
    */
  implicit val format: Format[LagomlearnState] = Json.format
}

/**
  * This interface defines all the events that the LagomlearnEntity supports.
  */
sealed trait LagomlearnEvent

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends LagomlearnEvent
...
/**
  ...
  */
sealed trait LagomlearnCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends LagomlearnCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String, organization: Option[String]) extends LagomlearnCommand[String]
...
/**
  ...
  * application loader.
  */
object LagomlearnSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[LagomlearnState]
  )
}
